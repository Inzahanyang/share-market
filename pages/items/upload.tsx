...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-10">
      ...
      <button className="mt-3 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 active:scale-95">
        Upload Product
      </button>
    </div>
  );
